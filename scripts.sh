...
python -m torch.distributed.launch --nproc_per_node=8 --use_env --master_port 30100 main_pretrain_combined.py -cn mse exp_name=full-test batch_size=16 accum_iter=12
