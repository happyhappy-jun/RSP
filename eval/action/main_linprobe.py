...
def main(cfg: DictConfig):
    ...
    if args.eval:
        test_stats = evaluate(data_loader_val, model, device, args, args)  # Use epoch 0 for eval mode
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        test_stats = evaluate(data_loader_val, model, device, args, args)  # epoch 0 for eval-only mode
        print(f"Accuracy of the network on the {len(dataset_val)} test images: {test_stats['acc1']:.1f}%")
