...
class RspCaptionTextQ(RspCaption):
    ...
    def __init__(self,
        ...
        self.joint_emb_norm = nn.LayerNorm(self.embed_dim)
    ...
    def forward_joint_emb(self, src_cls, tgt_cls, embedding):
        ...
        kv = torch.cat([src_cls, tgt_cls], dim=1) # [B, 2, decoder_embed_dim]
...
def rsp_joint_text_qvit_small_patch8_dec512d8b(**kwargs):
    model = RspCaptionTextQ(
        patch_size=8,
        embed_dim=384,
        depth=12,
        num_heads=6,
...
def rsp_joint_text_qvit_small_patch16_dec512d8b(**kwargs):
    model = RspCaptionTextQ(
        patch_size=16,
        embed_dim=384,
        depth=12,
...
def rsp_joint_text_qvit_base_patch16_dec512d8b(**kwargs):
    model = RspCaptionTextQ(
        patch_size=16,
        embed_dim=768,
        depth=12,
...
def rsp_joint_text_qvit_large_patch16_dec512d8b(**kwargs):
    model = RspCaptionTextQ(
        patch_size=16,
        embed_dim=1024,
        depth=24,
...
# Aliases
rsp_joint_text_qvit_small_patch8 = rsp_joint_text_qvit_small_patch8_dec512d8b
rsp_joint_text_qvit_small_patch16 = rsp_joint_text_qvit_small_patch16_dec512d8b
rsp_joint_text_qvit_base_patch16 = rsp_joint_text_qvit_base_patch16_dec512d8b
rsp_joint_text_qvit_large_patch16 = rsp_joint_text_qvit_large_patch16_dec512d8b
