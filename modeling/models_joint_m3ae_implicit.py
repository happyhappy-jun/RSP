...
class RspCaptionJointM3AEImplicit(RspCaption):
    """
...
def rsp_joint_m3ae_implicit_vit_small_patch8_dec512d8b(**kwargs):
    model = RspCaptionJointM3AEImplicit(
        patch_size=8,
        embed_dim=384,
        depth=12,
        num_heads=6,
...
def rsp_joint_m3ae_implicit_vit_small_patch16_dec512d8b(**kwargs):
    model = RspCaptionJointM3AEImplicit(
        patch_size=16,
        embed_dim=384,
        depth=12,
...
def rsp_joint_m3ae_implicit_vit_base_patch16_dec512d8b(**kwargs):
    model = RspCaptionJointM3AEImplicit(
        patch_size=16,
        embed_dim=768,
        depth=12,
...
def rsp_joint_m3ae_implicit_vit_large_patch16_dec512d8b(**kwargs):
    model = RspCaptionJointM3AEImplicit(
        patch_size=16,
        embed_dim=1024,
        depth=24,
...
# Aliases
rsp_joint_m3ae_implicit_vit_small_patch8 = rsp_joint_m3ae_implicit_vit_small_patch8_dec512d8b
rsp_joint_m3ae_implicit_vit_small_patch16 = rsp_joint_m3ae_implicit_vit_small_patch16_dec512d8b
rsp_joint_m3ae_implicit_vit_base_patch16 = rsp_joint_m3ae_implicit_vit_base_patch16_dec512d8b
rsp_joint_m3ae_implicit_vit_large_patch16 = rsp_joint_m3ae_implicit_vit_large_patch16_dec512d8b
