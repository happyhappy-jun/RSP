...
def rsp_vit_small_patch8_fixed(**kwargs):
    model = RSPFixed(
        patch_size=8,
        embed_dim=384,
        depth=12,
...
def rsp_vit_small_patch16_fixed(**kwargs):
    model = RSPFixed(
        patch_size=16,
        embed_dim=384,
        depth=12,
...
def rsp_vit_base_patch16_fixed(**kwargs):
    model = RSPFixed(
        patch_size=16,
        embed_dim=768,
        depth=12,
...
def rsp_vit_large_patch16_fixed(**kwargs):
    model = RSPFixed(
        patch_size=16,
        embed_dim=1024,
        depth=24,
